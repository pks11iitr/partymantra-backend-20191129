                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="priority" id="exampleInputEmail1" placeholder="Enter name">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control select2"
                                        ...
                                        <option  value="restaurant">Restaurant Collection</option>
                                        <option  value="party">Party Collection</option>
