            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <!-- /.card-header -->
                                        ...
                                        <form action="{{route('partner.menu.update',['id'=>$menus->id])}}" method="post" enctype="multipart/form-data">
						@csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    value="<?php echo $menus->name?>" placeholder="Enter name">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    value="<?php echo $menus->price?>" placeholder="Enter price" >
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    value="<?php echo $menus->cut_pice?>" placeholder="Enter cut pice" name="cut_pice">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
