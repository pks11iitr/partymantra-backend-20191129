...
class Order extends Model
{
    ...
    protected $fillable=['refid','payment_id_response', 'order_id_response','usingwallet','fromwallet','discount_type','instant_discount','total','date','time', 'payment_status', 'is_confirmed'];
