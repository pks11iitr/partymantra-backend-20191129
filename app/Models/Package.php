...
class Package extends Model
{
    ...
    protected $fillable = ['package_name','text_under_name','price','custom_package_detail','isactive','event_id','partneractive','partner_id','created_by', 'package_type','forparty','fordining'];
